  ...
  return (
    <section className="py-16 lg:py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-navy-950 via-navy-900 to-brand-dark p-8 sm:p-12 lg:p-16 text-white shadow-elevated border border-navy-800">
          ...
          <div className="relative z-10 max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider bg-sky-500/10 text-sky-400 border border-sky-400/20 mb-6">
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
              <button
                ...
                className="inline-flex items-center justify-center gap-2.5 bg-sky-500 hover:bg-sky-400 text-navy-950 px-8 py-4 rounded-full font-bold text-base shadow-lg shadow-sky-500/25 transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0 cursor-pointer"
              >
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2.5 bg-white/10 hover:bg-white/15 text-white border border-white/20 px-7 py-4 rounded-full font-bold text-base transition-colors cursor-pointer"
              >
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 text-white/90 hover:text-white px-4 py-3.5 text-sm font-bold transition-colors"
              >
