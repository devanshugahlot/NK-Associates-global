          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-6 space-y-6">
              ...
              <div className="space-y-4 pt-2">
                <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 flex items-start gap-3">
                  <div className="w-8 h-8 rounded-xl bg-brand-blue text-white font-bold text-sm flex items-center justify-center shrink-0">
                    1
                  </div>
                  <div>
                    <h4 className="text-sm font-bold text-navy-900">Tier 1: Associate Execution (Maker)</h4>
                ...
                <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 flex items-start gap-3">
                  <div className="w-8 h-8 rounded-xl bg-sky-500 text-navy-950 font-bold text-sm flex items-center justify-center shrink-0">
                    2
                  </div>
                  <div>
                    <h4 className="text-sm font-bold text-navy-900">Tier 2: Senior Manager Verification (Checker)</h4>
                    <p className="text-xs text-slate-600 mt-1">
                ...
                <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 flex items-start gap-3">
                  <div className="w-8 h-8 rounded-xl bg-emerald-500 text-white font-bold text-sm flex items-center justify-center shrink-0">
                    3
                  </div>
                  <div>
                    <h4 className="text-sm font-bold text-navy-900">Tier 3: Partner Delivery (Reviewer-Ready)</h4>
                    <p className="text-xs text-slate-600 mt-1">
            ...
            <div className="lg:col-span-6 bg-gradient-to-br from-navy-950 to-navy-900 text-white rounded-3xl p-8 sm:p-10 border border-navy-800 shadow-elevated">
              ...
              <div className="space-y-4 text-xs sm:text-sm">
                <div className="p-4 rounded-2xl bg-navy-850/90 border border-navy-700/80">
              ...
              <div className="mt-6 pt-5 border-t border-navy-800 flex items-center justify-between text-xs text-slate-400">
                <span className="flex items-center gap-1.5">
                  <Clock className="w-4 h-4 text-emerald-400" /> 24-Hour Query Response SLA
                </span>
