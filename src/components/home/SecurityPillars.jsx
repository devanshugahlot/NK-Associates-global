      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {siteContent.securityPillars.map((pillar) => {
            ...
            return (
              <div
                key={pillar.title}
                className="bg-navy-900/80 border border-navy-700/60 rounded-3xl p-7 hover:border-sky-400/40 hover:bg-navy-850 transition-all duration-300 shadow-elevated group"
              >
                <div className="w-12 h-12 rounded-2xl bg-sky-500/10 border border-sky-400/20 text-sky-400 group-hover:bg-sky-500 group-hover:text-navy-950 transition-colors duration-300 flex items-center justify-center mb-5">
        ...
        <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4 text-center">
          <button
            ...
            className="inline-flex items-center gap-2 bg-sky-500/15 hover:bg-sky-500/25 border border-sky-400/40 text-sky-300 px-6 py-3 rounded-full text-xs font-bold transition-colors cursor-pointer"
          >
