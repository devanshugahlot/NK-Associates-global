...
export default function FloatingWhatsApp() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex items-end flex-col gap-2">
      ...
      {showTooltip && (
        <div className="relative bg-white text-navy-900 text-xs px-3.5 py-2.5 rounded-2xl shadow-elevated border border-slate-200 flex items-center gap-2 max-w-[240px] animate-fade-in">
          <span>Need quick answers? <strong>WhatsApp: +91 75688 20015</strong></span>
          <button
      ...
      <a
        ...
        className="group relative flex items-center justify-center w-14 h-14 bg-emerald-500 hover:bg-emerald-600 text-white rounded-full shadow-lg shadow-emerald-500/30 transition-all duration-300 hover:scale-110 active:scale-95 focus:outline-none focus:ring-4 focus:ring-emerald-300"
      >
